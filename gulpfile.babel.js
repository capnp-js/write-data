...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-data-write.js",
      format: "umd",
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-data-write.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-data-write.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-data-write.js.map",
            },
          }))
